...
sum_transactions = 0
for transactions_homework in transactions_homework:
    if transactions_homework["add"] and "Хлеб" in transactions_homework["products"]:
        sum_transactions += transactions_homework["amount"]
